...
module FacebookAds
  module ServerSide
    ...
    class Event
      ...
      def hash
        [event_name, event_time, event_source_url, opt_out, event_id, user_data, custom_data, data_processing_options, data_processing_options_country, data_processing_options_state, action_source].hash
      end
